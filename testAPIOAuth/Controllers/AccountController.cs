...
namespace testAPIOAuth.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult ApiOAuth()
        {
            ...
            api.Channel.Send(api.PrepareRequestUserAuthorization(oAuthUrl, null, null));
        ...
        public ActionResult OAuth()
        {
            ...
            var accessTokenResponse = api.ProcessUserAuthorization();
            ...
            if (accessTokenResponse != null)
            {
                ...
                CreateAuthCookie(accessToken, accessToken);
            }
            else
            {
